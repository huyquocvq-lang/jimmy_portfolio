# Architecture Overview - Quoc Huy (Jimmy) Portfolio
...
flowchart TB
  ...
  subgraph routes [Routes]
    HOME[HomePage]
    P1[MmpCmsProject - Featured]
    P2[DentsuCmsProject]
    P3[YoolifeProject]
    P4[YooIocProject]
    P5[VnptPortalProject]
    P6[EledevoLandingProject]
    P7[FruitMarketProject]
  end
  ...
  subgraph data [Static data layer]
    ...
    EDU[education.js]
    EXP[experience.js]
    EMBEDS[projectEmbeds.js - empty registry]
  end
  ...
  HOME --> PROFILE & STATS & ABOUT & SKILLS & PERSONAL & PROJECTS & EDU & EXP
